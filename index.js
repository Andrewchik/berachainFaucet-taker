                                        ...
                                        .then((errorElement) => {
                                          if (errorElement) {
                                            page
                                              ...
                                              .then((errorMessage) => {
                                                if (errorMessage && errorMessage.includes("We are currently experiencing high traffic")){
                                                  console.log(
                                                    'Shit: '.red +
                                                      'Currently experiencing high traffic'.red
                                                  );
                                                  browser.close();
                                                  callback('error');
                                                }else{
...
function scheduleCronJob8H(address) {
  const job = new CronJob('0 */8 * * *', () => { // 0 */8 * * *
